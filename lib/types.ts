// Dummy response for the users API (to get the type)
const dummyResponse = {
  users: [
    {
      id: 1,
...
// Type of Response from the Users API
export type UsersResponseType = typeof dummyResponse;

// type for the Required User Details for Displaying in the Table
...
// Type for the Total Details for Pagination
